...
describeEast("SHAP platform functions", (test) => {
    ...
    Assert.examples(test, { shapTreeExplainer: ex.shapTreeExplainer, shapTreeExplainerInterventional: ex.shapTreeExplainerInterventional, shapKernelExplainer: ex.shapKernelExplainer });
