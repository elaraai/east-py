...
from east.types.types import FunctionType, IRType, NullType, StringType
...
def test_platforms(subtests):
    ...
    def describe_impl(name: str, test_fn: Any) -> None:
    ...
    def test_impl(name: str, test_fn: Any) -> None:
