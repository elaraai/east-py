...
```python
from east_py import is_east_option  # Use existing east-py helper

def _get_option(value, default):
    """Extract value from EastSome or return default for EastNone."""
    if is_east_option(value) and value.is_some():
        return value.value
    return default
